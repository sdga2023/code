<script>
  /* modified version of Typeahead.svelte
  https://github.com/metonym/svelte-typeahead
  that exposes a forceFocus prop
  */
...
>
  ...
  />
  <ul class:svelte-typeahead-list={true} role="listbox" aria-labelledby="{id}-label" id="{id}-listbox">
    {#if showResults}
